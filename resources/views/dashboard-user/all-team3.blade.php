...
<body
    ...
    <div class="sm:mx-4 bg-gray-500 flex justify-center ">
        <button x-show="card_page == false" @click="current_page=0; card_page=true; active=0"
            class="text-white bg-gray-500 p-2 mx-auto rounded-lg">
    ...
    {{-- <div class="flex my-3 items-center mx-24 justify-center mb-5  h-[100px] rounded-lg border-dotted border-2">
        <button type="button"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Buat
            Tim</button>
    </div> --}}
    ...
    <div x-show="card_page == true"
        class="flex mt-8 mx-2 justify-between lg:grid lg:grid-cols-3 lg:mx-24 gap-x-6 h-[42px] max-h-[42px] ">
        ...
        <div class="flex w-full space-x-4">
            <div x-show="card_page" class="flex flex-col w-full lg:w-[30%]   overflow-hidden">
                ...
                <ul class="flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-col py-4" id="myTab"
                    ...
                    <li @click="current_page=1; window.innerWidth < 768 ? card_page = false : card_page = true; active=1"
                        class="py-3 sm:py-2 px-2  xl:mr-5">
                        <a href="#"
                            class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                            <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
            ...
            <div :class="card_page == false ? 'block' : 'hidden lg:block'" class="lg:w-[70%] mt-2">
                <div x-show="current_page == 1" class="bg-white rounded-md   justify-start">
                        ...
                        {{-- <div class="flex mt-4">
                            ...
                            <div class="mx-8">
                                <button type="button"
                                    ...
                                    <svg aria-hidden="true" class="w-6 h-6 -ml-px " fill="currentColor"
                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    {{-- <div class="mx-10 xl:">
                        ...
                        <ul class="text-gray-500 mt-1 mx-4 list-decimal">
                            ...
                            <li>Memahami dinamika fungsi penjualan dan bagaimana hal ini mempengaruhi perolehan prospek
                            </li>
                ...
                <div x-show="current_page == 0"
                    class="bg-gray-100 flex justify-center items-center md:min-h-screen text-center rounded-md sm:mt-5 justify-start">

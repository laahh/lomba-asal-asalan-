...
<body class="">
    ...
    <div class="jumbotron ">
        ...
        {{-- Home --}}
        <section class="bg-gray-50 -z-30">
            <div
            class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center"
            >
            <div class="md:w-1/2 md:max-w-1/2 relative z-50 text-left">
                <h1
                class=" text-3xl font-extrabold text-transparent sm:text-5xl"
                >
                Jadilah Tim Leader Atau Member
...
<div class="absolute top-[150px] z-30 left-0 w-[600px] h-[300px] ">

...
<body
                            ...
                            <div x-show.transition="step === 'complete'">
                                <div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
                                    <div>
                                        ...
                                        <h2 class="text-2xl mb-4 text-gray-800 text-center font-bold">Pembuatan Tim
                                            Berhasil</h2>

                                        <div class="text-gray-600 mb-8">
                                            Silahkan melanjutkan proses berikutnya untuk mengelola tim Anda dan membuka
                                            proses rekruitment.
                                        </div>
                            ...
                            <div x-show.transition="step != 'complete'">
                                ...
                                <div class="">
                                    ...
                                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                        <div class="flex-1 text-center ">
                                            ...
                                            <ol
                                                class="flex items-center justify-evenly w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white  rounded-lg   sm:text-base  sm:p-4 sm:space-x-4">
                                                <li x-bind:class="step == 1 ? 'text-blue-600  : ''"
                                                    class="flex items-center  ">
                                                    <span x-bind:class="step == 1 ? ' border-blue-600 ' : ''"
                                                ...
                                                <li x-bind:class="step == 2 ? 'text-blue-600 ' : ''"
                                                    class="flex items-center">
                                                    <span x-bind:class="step == 2 ? ' border-blue-600 ' : ''"
                                ...
                                <div class="py-4">
                                    <div x-show.transition.in="step === 1">
                                        ...
                                        <div class="mb-5">
                                            <label for="nama_tim"
                                                class="block mb-2 text-sm font-medium text-gray-900 ">Nama Tim</label>
                                            <input type="text" id="nama_tim"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                                                placeholder="Tim Kage.." required>
                                        </div>
                                        <div class="mb-5">

                                            <label for="kategori"
                                                class="block mb-2 text-sm font-medium text-gray-900 :text-white">Kategori
                                                Tim</label>
                                            <select id="kategori"
                                        ...
                                        <div class="mb-5">
                                            <label for="deskripsi"
                                                class="block mb-2 text-sm font-medium text-gray-900 :text-white">Deskripsi
                                                Tim</label>
                                    ...
                                    <div x-show.transition.in="step === 2">
                                            ...
                                            <div class="mb-5 shadow-md p-5">
                                                <div class="flex p-2 justify-center bg-gray-100 mb-3">
                                                    ...
                                                    <button
                                                        ...
                                                        @click="hapusLowongan(index)" type="button">
                                                ...
                                                <form x-data="color()">
                                                        ...
                                                        <div class="flex w-full items-center">
                                                            <div class="w-full">
                                                                <label for="colorSelected"
                                                                    ...
                                                                    Warna Role</label>
                                                                <input id="colorSelected" type="text"
                                                    ...
                                                    <div class="w-full">
                                                        <label for="lowongan"
                                                            class="block mb-2 text-sm font-medium text-gray-900 :text-white">Lowongan
                                                            & kualifikasi Tim</label>
                                        ...
                                        <button class="w-full text-white p-2 rounded-lg shadow-md bg-green-500"
                                            @click="tambahLowongan()">
                                    ...
                                    <div class="flex justify-between">
                                        <div class="w-1/2">
                                            <button x-show="step > 1" @click="step--"
                                                class="w-32 focus:outline-none py-2 px-5 rounded-lg shadow-sm text-center text-gray-600 bg-white hover:bg-gray-100 font-medium border">Sebelumnya</button>
                                        </div>

                                        <div class="w-1/2 text-right">
                                            <button x-show="step < 2" @click="step++"
                                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium">Selanjutnya</button>

                                            <button @click="step = 'complete'" x-show="step == 2"
                                                class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center text-white bg-blue-500 hover:bg-blue-600 font-medium">Selesai</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- Mobile banner --}}
    <div x-show="card_page" class="sm:hidden mx-4 mb-4 mt-4 flex">
        <div>
    ...
    {{-- <div class="h-[200px] w-[500px]">
        <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_anr54dsb.json" background="transparent"
        ...
        <div class="flex relative w-full justify-center  space-x-4">
            ...
            <div class="lg:w-[50%] relative flex-col rounded-lg">
                <div class="flex  text-center justify-center items-center flex-row mt-12">
                    ...
                    <h1
                        class="xl:text-5xl drop-shadow-md font-extrabold bg-clip-text text-transparent bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-sky-400 to-blue-800 text-center flex w-full justify-center font-bold font-poppins">
                        Ayo Buat atau Join Tim Impianmu di TeamUp</h1>


                </div>
                <div class="mt-10 w-full flex justify-center">
                    <button type="button" data-modal-toggle="modalTim"
                        class="text-white flex justify-center bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Buat
                        Tim</button>
                </div>
    ...
    <div class="sm:mx-4 bg-gray-400 flex justify-center ">
        <button x-show="card_page == false" @click="current_page=0; card_page=true; active=0"
            class="text-white bg-gray-400 p-2 mx-auto rounded-lg">
    ...
    <div x-show="card_page == true"
        class="flex mx-2 justify-between lg:grid lg:grid-cols-3 lg:mx-24 gap-x-6 h-[42px] max-h-[42px] ">
        ...
        <form class="flex w-full md:hidden flex items-center">
            <div class="relative w-full h-full">
                ...
                <input type="text" id="table-search-users"
                    ...
                    placeholder="Cari tim" data-drawer-target="drawer_tugas" data-drawer-show="drawer_tugas"
            ...
            <div id="drawer_tugas"
                ...
                <form>
                    <div class="">
                        ...
                        <div class="my-4">
                            <label for="countries"
                                class="block mb-2 text-sm font-medium text-gray-900 :text-white">Kategori</label>
                            <select id="countries"
                                class=" lg:hidden h-[42px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500">
        ...
        <select id="countries"
            class="hidden md:block md:w-[30%] lg:w-full h-[42px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500">
            <option selected>Semua Kategori</option>
            <option value="web">Web Development</option>
            <option value="mobile">Mobile Development</option>
            <option value="ilustrator">Ilustrator</option>
    ...
    <div class="hidden md:block">
        <div
            class="sm:mx-4 bg-red-500 lg:mx-24 grid grid-cols-1 sm:grid-cols-1 gap-6 md:grid-cols-4 lg:grid-cols-4 mt-3">
            ...
            <div class="">
                ...
                <div class="my-4">
                    <label for="countries"
                        class="block mb-2 text-sm font-medium text-gray-900 :text-white">Kategori</label>
                    <select id="countries"
                        class=" h-[42px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500">
                        <option selected>Semua Kategori</option>
                        <option value="web">Web Development</option>
                        <option value="mobile">Mobile Development</option>
                        <option value="ilustrator">Ilustrator</option>
    ...
    <div x-on:resize.window="window.innerWidth <= 640 && current_page != 0 ? card_page = false : card_page = true"
        class="lg:mx-24 min-h-screen flex flex-row ">
        <div class="flex w-full space-x-4">
            <div x-show="card_page" class="flex flex-col w-full lg:w-[30%]   overflow-hidden">

                <ul class="flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-col py-4" id="myTab"
                    data-tabs-toggle="#myTabContent" role="tablist">

                    <li @click="current_page=1; window.innerWidth < 1024 ? card_page = false : card_page = true; active=1"
                        class="py-3 sm:py-2 px-2  xl:mr-5">
                        <div
                                ...
                                <li class="">
                                    <div class="flex cursor-pointer items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <div class="flex">
                                                <img class="w-12 h-12 rounded-full" src="{{asset('assets/tim/1.png')}}"
                                                    alt="Neil image">
                                            </div>
                                        </div>
                    ...
                    <li @click="current_page=2; window.innerWidth < 1024 ? card_page = false : card_page = true; active=2"
                        class="py-3 sm:py-2 px-2  xl:mr-5">
                        <div
                            class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                            <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                                <li class="">
                                    <div class="flex cursor-pointer items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <div class="flex">
                                                <img class="w-12 h-12 rounded-full" src="{{asset('assets/tim/2.png')}}"
                                                    alt="Neil image">
                                            </div>
                                        </div>
                                        <div class="flex-1 min-w-0">
                    ...
                    <li @click="current_page=3; window.innerWidth < 1024 ? card_page = false : card_page = true; active=3"
                        class="py-3 sm:py-2 px-2  xl:mr-5">
                        <div
                            class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                            <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                                <li class="">
                                    <div class="flex cursor-pointer items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <div class="flex">
                                                <img class="w-12 h-12 rounded-full" src="{{asset('assets/tim/3.png')}}"
                                                    alt="Neil image">
                                            </div>
                                        </div>
                                        <div class="flex-1 min-w-0">
                    ...
                    <li @click="current_page=4; window.innerWidth < 1024 ? card_page = false : card_page = true; active=4"
                        class="py-3 sm:py-2 px-2  xl:mr-5">
                        <div
                            class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                            <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                                <li class="">
                                    <div class="flex cursor-pointer items-center space-x-4">
                                        <div class="flex-shrink-0">
                                            <div class="flex">
                                                <img class="w-12 h-12 rounded-full" src="{{asset('assets/tim/4.png')}}"
                                                    alt="Neil image">
                                            </div>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate :text-white">
                                                Hummingbird Digital Tech
                                            </p>
                                            <p class="text-sm text-gray-500 truncate :text-gray-400">
                                                Web development
                                            </p>
            ...
            <div :class="card_page == false ? 'block' : 'hidden lg:block'" class="lg:w-[70%] mt-2">
                <div x-show="current_page == 1" class="bg-white rounded-md   justify-start">
                    ...
                    <div class="mx-10 mt-3">
                        <div class="flex items-center space-x-2 mb-2">
                            <img class="w-10 h-10 xl:w-20 xl:h-20 rounded-full" src="{{asset('assets/tim/1.png')}}">
                            <div>
                                <h1 class="xl:text-2xl font-semibold mt-1">Connect Technology </h1>
                                <h1 class="text-gray-500 truncate  ">Tim Leader : Ifa Aprillianto </h1>

                            </div>
                            <button x-show="card_page == false" @click="current_page=0; card_page=true; active=0"
                                class="text-gray-200 text-xs rounded-lg p-3">
                    ...
                    <div class="mx-10">
                        ...
                        <p class="text-gray-500 mt-1">Tim pengembang perangkat lunak yang handal dan berpengalaman dalam
                            membangun aplikasi web dan mobile. Kami membuka kesempatan kepada Anda yang memiliki
                            kemampuan dalam pemrograman dengan berbagai bahasa seperti JavaScript, Python, dan Ruby
                        </p>

                        <div class="flex items-center space-x-4 mt-8">
                            <h1 class="text-lg mb-1 font-semibold">Posisi Yang Dibutuhkan</h1>
                            <button x-show="main_menu_lowongan == false"
                                @click="current_page_lowongan=0; main_menu_lowongan=true; active_lowongan=0"
                                class="text-white bg-gray-500 p-2 rounded-lg">
                        ...
                        <div x-on:resize.window="window.innerWidth <= 640 && current_page_lowongan != 0 ? main_menu_lowongan = false : main_menu_lowongan = true"
                            class="flex w-full flex-col sm:h-[40vh] sm:h-max-[40vh] md:h-[40vh] md:max-h-[40vh] sm:flex-row xl:flex xl:w-full">
                            <div x-show="main_menu_lowongan == true "
                                class=" order-2 h-[40vh]  py-2 sm:h-[40vh] sm:h-max-[40vh] md:h-[40vh] md:max-h-[40vh] sm:order-1 sm:w-1/2 xl:max-h-[40vh] scrollbar xl:overflow-y-auto">
                                ...
                                <div id="accordion-flush" data-accordion="collapse"
                                    ...
                                    <ul class="pr-2">
                                        <li :class="active_lowongan==1 ? 'border-2 border-blue-500' : ''"
                                            ...
                                            <h2 id="accordion-flush-heading-0">
                                                <div class="flex items-center justify-between ">
                                                    <div id="tooltip_lowongan"
                                                        @click="current_page_lowongan = 1; window.innerWidth < 640 ? main_menu_lowongan = false : main_menu_lowongan = true; active_lowongan = 1"
                                        ...
                                        <li :class="active_lowongan==2 ? 'border-2 border-blue-500' : ''"
                                            class="bg-white rounded-md shadow-md px-2 mb-3 cursor-pointer ">

                                            <h2 id="accordion-flush-heading-1">
                                                <div class="flex items-center justify-between ">
                                                    <div id="tooltip_lowongan"
                                                        @click="current_page_lowongan = 2; window.innerWidth < 640 ? main_menu_lowongan = false : main_menu_lowongan = true; active_lowongan = 2"
                                                        class="flex items-center h-[64px] w-full">
                                        ...
                                        <li :class="active_lowongan==3 ? 'border-2 border-blue-500' : ''"
                                            class="bg-white rounded-md shadow-md px-2 mb-3 cursor-pointer ">

                                            <h2 id="accordion-flush-heading-2">
                                                <div class="flex items-center justify-between ">
                                                    <div id="tooltip_lowongan"
                                                        @click="current_page_lowongan = 3; window.innerWidth < 640 ? main_menu_lowongan = false : main_menu_lowongan = true; active_lowongan = 3"
                                                        class="flex items-center h-[64px] w-full">
                            ...
                            <div :class="current_page_lowongan != 0 ? 'bg-white' : 'bg-gray-50'"
                                ...
                                <div x-show="current_page_lowongan == 1"
                                    ...
                                    class="w-full relative  h-[60vh] h-max-[60vh] sm:h-full sm:h-max-full md:p-2   rounded-lg">
                                    ...
                                    <div class="container mx-auto p-2">
                                        ...
                                        <ul
                                            ...
                                            <li class="mb-1">Memiliki pengalaman minimal 2 tahun sebagai Frontend
                                                Developer.</li>
                                        ...
                                        <ul
                                            class="list-disc ml-4 mb-4 text-sm xl:mx-2 leading-7 font-poppins text-[#7D7777] :text-gray-400 text-justify">
                                            <li class="mb-1">Mengembangkan tampilan antarmuka pengguna (UI) untuk
                                                aplikasi web dengan menggunakan HTML, CSS, dan JavaScript.</li>
                                            <li class="mb-1">Menggunakan framework front-end seperti ReactJS, VueJS,
                                                atau AngularJS untuk membangun aplikasi web yang cepat dan responsif.
                                            </li>
                                ...
                                <div x-show="current_page_lowongan == 2"
                                    ...
                                    <div class="container mx-auto p-2">
                                        ...
                                        <ul
                                            class="list-disc ml-4 mb-4 text-sm xl:mx-2 leading-7 font-poppins text-[#7D7777] :text-gray-400 text-justify">
                                            <li class="mb-1">Pengalaman kerja minimal 3 tahun sebagai Backend Developer
                                            </li>
                                            <li class="mb-1">Memiliki pengetahuan yang kuat tentang bahasa pemrograman
                                                seperti Java, Python, atau Node.js</li>
                                            <li class="mb-1">Memiliki pengalaman dalam penggunaan framework seperti
                                                Spring, Django, atau Express.js</li>
                                            <li class="mb-1">Memiliki pemahaman yang baik tentang arsitektur aplikasi
                                                dan penggunaan database</li>
                                            <li class="mb-1">Memiliki keterampilan dalam mengelola infrastruktur dan
                                                pengujian kode</li>
                                        </ul>
                                        <h3 class="text-lg font-semibold mb-2">Jobdesk:</h3>
                                        <ul
                                            class="list-disc ml-4 mb-4 text-sm xl:mx-2 leading-7 font-poppins text-[#7D7777] :text-gray-400 text-justify">
                                            <li class="mb-1">Merancang, mengembangkan, dan memelihara sistem backend
                                                untuk aplikasi web dan mobile</li>
                                            <li class="mb-1">Berkolaborasi dengan tim frontend untuk memastikan
                                                integrasi yang mulus antara frontend dan backend</li>
                                            <li class="mb-1">Menerapkan standar keamanan dan perlindungan data dalam
                                                sistem</li>
                                            <li class="mb-1">Mengevaluasi, memperbaiki, dan memelihara kinerja sistem
                                            </li>
                                ...
                                <div x-show="current_page_lowongan == 3"
                                    ...
                                    <div class="container mx-auto p-2">
                                        ...
                                        <ul
                                            class="list-disc ml-4 mb-4 text-sm xl:mx-2 leading-7 font-poppins text-[#7D7777] :text-gray-400 text-justify">
                                            <li class="mb-1">Merancang, mengembangkan, dan memelihara desain UI/UX untuk
                                                aplikasi web dan mobile</li>
                                            <li class="mb-1">Mempelajari kebutuhan pengguna dan merancang pengalaman
                                                pengguna yang intuitif dan menarik</li>
                                            <li class="mb-1">Berkolaborasi dengan tim pengembang dan pemangku
                                                kepentingan untuk mengidentifikasi dan menyelesaikan masalah pengalaman
                                                pengguna</li>
                                            <li class="mb-1">Mengumpulkan dan menganalisis data pengguna untuk memahami
                                                pola perilaku dan mengevaluasi desain</li>
                                            <li class="mb-1">Menerapkan prinsip-prinsip desain yang efektif dan efisien,
                                                termasuk desain responsif dan aksesibilitas</li>
                                        </ul>
                                        <h3 class="text-lg font-semibold mb-2">Jobdesk:</h3>
                                        <ul
                                            class="list-disc ml-4 mb-4 text-sm xl:mx-2 leading-7 font-poppins text-[#7D7777] :text-gray-400 text-justify">
                                ...
                                <div x-show="current_page_lowongan == 0"
                                    class="w-full relative sm:p-2 sm:h-full bg-gray-100 sm:bg-transparent text-gray-300 rounded-lg text-center">
                        ...
                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto ">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="max-h-[70vh] overflow-y-auto scrollbar py-6 px-6 lg:px-8">
                                    ...
                                    <div class="mb-2">
                                        <input type="hidden" id="teamID" name="slug"">
                            <label for=" message"
                                        ...
                                        <textarea id="message" rows="4"
                                            ...
                                            name="message" placeholder="Tuliskan pesan lamaranmu..."></textarea>
                                    ...
                                    <div class="mb-2">
                                        <label for="message"
                                            ...
                                            CV, portfolio, dan dokumen pendukung</label>
                                        <input id="filepondInput" type="file" class="filepond" name="filepondInput"
                ...
                <div x-show="current_page == 2" class="bg-white rounded-md   justify-start">

                    <div class="mx-10 mt-3">
                        <div class="flex items-center space-x-2 mb-2">
                            <img class="w-10 h-10 xl:w-20 xl:h-20 rounded-full" src="{{asset('assets/tim/1.png')}}">
                            <div>
                                <h1 class="xl:text-2xl font-semibold mt-1">Mauris Consulting </h1>
                                <h1 class="text-gray-500 truncate  ">Tim Leader : Ifa Aprillianto </h1>
                    ...
                    <div class="mx-10">
                        <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
                        <p class="text-gray-500 mt-1">Kami adalah tim freelance yang ahli dalam strategi SEO dan digital
                            marketing untuk meningkatkan visibilitas dan lalu lintas website. Kami dapat membantu
                            meningkatkan peringkat website di mesin pencari dan meningkatkan jumlah pengunjung dengan
                            menggunakan teknik-teknik seperti optimasi kata kunci, backlink, dan konten berkualitas.
                            Kami juga dapat membantu dalam mengembangkan strategi pemasaran digital dan media sosial.
                        </p>
                ...
                <div x-show="current_page == 3" class="bg-white rounded-md   justify-start">

                    <div class="mx-10 mt-3">
                        <div class="flex items-center space-x-2 mb-2">
                            <img class="w-10 h-10 xl:w-20 xl:h-20 rounded-full" src="{{asset('assets/tim/3.png')}}">
                            <div>
                                <h1 class="xl:text-2xl font-semibold mt-1">Healthy Creative People</h1>
                                <h1 class="text-gray-500 truncate  ">Tim Leader : Ifa Aprillianto </h1>
                    ...
                    <div class="mx-10">
                        <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
                        <p class="text-gray-500 mt-1">Kami adalah tim freelance yang terdiri dari desainer grafis dan UX
                            designer yang ahli dalam membuat desain tampilan website yang menarik dan fungsional. Kami
                            juga memiliki kemampuan untuk melakukan riset tentang user experience dan mengembangkan
                            wireframe dan prototipe untuk website atau aplikasi web. Kami juga dapat membantu dalam
                            pengembangan frontend website.
                        </p>
                    ...
                    <div class="flex justify-center">
                        <button type="button" data-modal-toggle="modalHealthy"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Lamar</button>
                    </div>

                    <div id="modalHealthy" tabindex="-1"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full ">
                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto ">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <button type="button"
                                    class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                    data-modal-toggle="modalHealthy">
                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                            ...
                            <label for=" message"
                                    ...
                                    <div class="mb-2">
                                        <label for="message"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload
                                            CV, portfolio, dan dokumen pendukung</label>
                                        <input id="healthy" type="file" class="filepond" name="filepondInput" multiple
                ...
                <div x-show="current_page == 4" class="bg-white rounded-md   justify-start">

                    <div class="mx-10 mt-3">
                        <div class="flex items-center space-x-2 mb-2">
                            <img class="w-10 h-10 xl:w-20 xl:h-20 rounded-full" src="{{asset('assets/tim/4.png')}}">
                            <div>
                                <h1 class="xl:text-2xl font-semibold mt-1">Hummingbird Digital Tech</h1>
                                <h1 class="text-gray-500 truncate  ">Tim Leader : Ifa Aprillianto </h1>
                    ...
                    <div class="mx-10">
                        <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
                        <p class="text-gray-500 mt-1">Kami adalah tim yang mempunyai spesialisasi dalam desain web,
                            mulai dari mockup hingga implementasi. Dengan fokus pada tampilan dan kegunaan, kami mampu
                            menciptakan desain yang menawan dan mudah digunakan oleh pengguna. Kami juga ahli dalam
                            mengoptimalkan desain untuk meningkatkan performa dan SEO situs web.
                        </p>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center">
                                ...
                                <svg aria-hidden="true" class="w-5 h-5 text-gray-300 :text-gray-500" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    FilePond.create(
    document.querySelector('#healthy')
    );
    </script>
    <script>
        function color() {

...
<div class="sm:mx-4 bg-gray-400 flex justify-center ">
    <button x-show="card_page == false" @click="current_page=0; card_page=true; active=0" class="text-white bg-gray-400 p-2 mx-auto rounded-lg">
...
<div class="flex hidden lg:flex my-3 items-center mx-24 justify-between mb-5 px-2 h-[100px] rounded-lg border-dashed border-2">
    <h3 class="text-blue-700 text-3xl font-bold">Tim List</h3>
    <button type="button" data-modal-toggle="modalTim" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Buat Tim</button>
</div>

<!-- component -->

<div x-show="card_page == true" class="flex mx-2 justify-between lg:grid lg:grid-cols-3 lg:mx-24 gap-x-6 h-[42px] max-h-[42px] ">
    ...
    <div  x-on:resize.window="window.innerWidth <= 640 && current_page != 0 ? card_page = false : card_page = true" class="lg:mx-24 min-h-screen flex flex-row ">
        <div class="flex w-full space-x-4">
            <div x-show="card_page" class="flex flex-col w-full lg:w-[30%]   overflow-hidden">
                ...
                <li @click="current_page=2; window.innerWidth < 1024 ? card_page = false : card_page = true; active=2" class="py-3 sm:py-2 px-2  xl:mr-5">
                    <div 
                    class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                    <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                        <li class="">
            ...
            <li @click="current_page=3; window.innerWidth < 1024 ? card_page = false : card_page = true; active=3" class="py-3 sm:py-2 px-2  xl:mr-5">
                <div 
                class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                    <li class="">
            ...
            <li @click="current_page=4; window.innerWidth < 1024 ? card_page = false : card_page = true; active=4" class="py-3 sm:py-2 px-2  xl:mr-5">
                <div 
                class="rounded-xl border-l-4 shadow-md border-blue-500 block pt-6 pb-6 pl-3 pr-3 bg-white  hover:bg-gray-100 :bg-gray-800 :border-gray-700 :hover:bg-gray-700">
                <ul role="list" class="divide-y divide-gray-200 :divide-gray-700">
                    <li class="">
...
<div :class="card_page == false ? 'block' : 'hidden lg:block'" class="lg:w-[70%] mt-2">
    <div x-show="current_page == 1" class="bg-white rounded-md   justify-start">
        ...
        <div class="mx-10">
            ...
            <p class="text-gray-500 mt-1">Tim pengembang perangkat lunak yang handal dan berpengalaman dalam membangun aplikasi web dan mobile. Kami membuka kesempatan kepada Anda yang memiliki kemampuan dalam pemrograman dengan berbagai bahasa seperti JavaScript, Python, dan Ruby
            </p>
        ...
        <div class="flex justify-center">
            <button type="button" data-modal-toggle="modalLamar" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Lamar</button>
        </div>
        
        <div id="modalLamar" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full ">
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto ">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="modalLamar">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        <span class="sr-only">Close modal</span>
                    </button>
                    <div class="max-h-[70vh] overflow-y-auto scrollbar py-6 px-6 lg:px-8">
                        ...
                        <div class="mb-2">
                            ...
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pesan lamaran:</label>
                            <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="message" placeholder="Tuliskan pesan lamaranmu..."></textarea>
                            
                        </div>
                        <div class="mb-2">
                            <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Pilih lowongan</label>
                        ...
                        <div class="mb-2">
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload CV, portfolio, dan dokumen pendukung</label>
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lamar</button>
    ...
    <div x-show="current_page == 2" class="bg-white rounded-md   justify-start">
        ...
        <div class="mx-10">
            <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
            <p class="text-gray-500 mt-1">Kami adalah tim freelance yang ahli dalam strategi SEO dan digital marketing untuk meningkatkan visibilitas dan lalu lintas website. Kami dapat membantu meningkatkan peringkat website di mesin pencari dan meningkatkan jumlah pengunjung dengan menggunakan teknik-teknik seperti optimasi kata kunci, backlink, dan konten berkualitas. Kami juga dapat membantu dalam mengembangkan strategi pemasaran digital dan media sosial.
            </p>
    ...
    <div x-show="current_page == 3" class="bg-white rounded-md   justify-start">
        ...
        <div class="mx-10">
            <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
            <p class="text-gray-500 mt-1">Kami adalah tim freelance yang terdiri dari desainer grafis dan UX designer yang ahli dalam membuat desain tampilan website yang menarik dan fungsional. Kami juga memiliki kemampuan untuk melakukan riset tentang user experience dan mengembangkan wireframe dan prototipe untuk website atau aplikasi web. Kami juga dapat membantu dalam pengembangan frontend website.
            </p>
        ...
        <div class="flex justify-center">
            <button type="button" data-modal-toggle="modalHealthy" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Lamar</button>
        </div>
        
        <div id="modalHealthy" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full ">
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto ">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="modalHealthy">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        <span class="sr-only">Close modal</span>
                    </button>
                    <div class="max-h-[70vh] overflow-y-auto scrollbar py-6 px-6 lg:px-8">
    ...
    <div x-show="current_page == 4" class="bg-white rounded-md   justify-start">
        ...
        <div class="mx-10">
            <h1 class="text-xl font-semibold mt-8">Deskripsi Team </h1>
            <p class="text-gray-500 mt-1">Kami adalah tim yang mempunyai spesialisasi dalam desain web, mulai dari mockup hingga implementasi. Dengan fokus pada tampilan dan kegunaan, kami mampu menciptakan desain yang menawan dan mudah digunakan oleh pengguna. Kami juga ahli dalam mengoptimalkan desain untuk meningkatkan performa dan SEO situs web.
            </p>
    ...
    <div x-show="current_page == 0" class="bg-gray-100 text-gray-300 flex justify-center items-center md:min-h-screen text-center rounded-md sm:mt-5 justify-start">

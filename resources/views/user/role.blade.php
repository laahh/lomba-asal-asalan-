...
<body class="bg-gray-50 font-poppins">
  ...
  <div class=" md:flex sm:flex-wrap sm:justify-center  sm:mx-3  ">
    <div
      class=" text-blue-600   transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110  duration-300  rounded-3xl shadow-xl w-[340px] mt-3   h-[500px]   mx-auto  sm:mx-4 mb-9 ">

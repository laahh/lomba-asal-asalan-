...
<body class="bg-[#FFF5EC] font-poppins">
  ...
  <div class=" md:flex sm:flex-wrap sm:justify-center  sm:mx-3  ">
    <div class=" text-[#F2994A]  hover:text-white transition ease-in-out delay-150 bg-white hover:-translate-y-1 hover:scale-110 hover:bg-[#F2994A] duration-300  rounded-3xl shadow-xl w-[340px] mt-3   h-[500px]   mx-auto  sm:mx-4 mb-9 ">
        ...
        <h5 class="mb-4 text-3xl font-bold  px-[100px]">Leader</h5>
          ...
          <ul role="list" class="my-7 space-y-5">
              ...
              <li class="flex space-x-3 line-through decoration-gray-500">
                  <!-- Icon -->
                  <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 text-gray-400 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>

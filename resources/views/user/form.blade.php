                                        ...
                                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                            <div class="flex-1 text-center ">
                                                ...
                                                <ol class="flex items-center justify-evenly w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white  rounded-lg  dark:text-gray-400 sm:text-base dark:bg-gray-800 dark:border-gray-700 sm:p-4 sm:space-x-4">
                                                    ...
                                                    <li x-bind:class="step == 3 ? ' text-blue-600 dark:text-blue-500' : ''" class="flex items-center">
                                                        <span x-bind:class="step == 3 ? ' border-blue-600 dark:border-blue-500' : ''"  class="flex items-center justify-center w-5 h-5 mr-2 text-xs border border-gray-500 rounded-full shrink-0 dark:border-gray-400">
                                                            3
                                                        </span>
                                                        Review
                                                    </li>
                                    ...
                                    <div class="py-4">	
                                        <div x-show.transition.in="step === 1">
                                            <div class="mb-5 text-center">
                                                <div class="mx-auto  mb-4 shadow-inset">
                                        ...
                                        <div x-show.transition.in="step === 2">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <trix-editor input="lowongan"></trix-editor>  
                                            </div>

            ...
            <div class="w-full h-100"> 
                ...
                <form action="" class="mt-6" >
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name="password" id="email" placeholder="Enter your password" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-purple-500 focus:bg-white focus:outline-none" autofocus autocomplete required>
                ...
                <a href="{{url('auth/redirect')}}" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">

    ...
    <section class="flex flex-col md:flex-row h-screen items-center ">
        <div
            ...
            <div class="w-full h-100">
                ...
                <img class="mt-24 w-52 mx-auto" src="{{asset('img/logo-login.png')}}" alt="">
                <h1 class="font-poppins text-3xl  text-center">Register</h1>
                <form action="" class="mt-4">
                    ...
                    <a href="{{url('/role')}}">
                        <button type="button"
                            class="w-full block bg-[#191C32]  text-white font-semibold rounded-3xl px-4 py-3 mt-5 ">
                            Log In
                        </button>
                    </a>
                </form>
                ...
                <div class="inline-flex justify-center mx-auto -mt-4">
